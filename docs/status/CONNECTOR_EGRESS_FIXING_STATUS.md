...
credential-kind eligibility — roadmap R3-394, in Residuals below.)* · **Created:** 2026-08-27 (roadmap R3-227)
...
- **The hostile author (§2.1 / §5 move 9).** Target-fixing pins faithfully to whatever
  ...
  **unvalidated** — the E3 comprehension study has not run and must now include an
  ...
  threat.
- **Credential-kind eligibility on the §3.1 path is unenforced (roadmap R3-394, found
